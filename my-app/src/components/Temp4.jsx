...
const Temp4 = () => {
  ...
  return (
    <div className="resume-main-container flex w-full" style={{marginLeft:"70px"}}>
      <Sidebar
        onAddSection={() => {}}
      ...
      <div className="main-content resume-wrapper flex bg-gray shadow-lg rounded-lg w-full max-w-[1000px] p-4 relative">
        {activeSection === "name" && (
          <FaCog
